...
class SmartScheduler {
  ...
  scheduleDay(date, options) {
    ...
    for (const program of prioritizedPrograms) {
      let vendor = null;
    ...
    for (const listEmail of distributionLists) {
      try {
        ...
        const distributionHtmlBody = `
          <div style="background: #e3f2fd; border-left: 4px solid #1976d2; padding: 15px; margin-bottom: 20px; font-family: Arial, sans-serif;">
            <h3 style="color: #1565c0; margin: 0 0 10px 0;">📧 Distribution List Delivery</h3>
            <p style="margin: 0; font-size: 14px;">
              This email is being sent to a large distribution list. If you're not seeing this email in your inbox:
            </p>
            <ul style="margin: 10px 0; padding-left: 20px; font-size: 14px;">
              <li>Check your spam/junk folder</li>
              <li>Add <strong>${Session.getActiveUser().getEmail()}</strong> to your safe senders list</li>
              <li>Contact your IT department if delivery issues persist</li>
            </ul>
          </div>
          ${htmlBody}
        `;
  ...
  sendEmail(recipient, weekData) {
    ...
    const htmlBody = `
      <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto;">
        <h2 style="color: #1a73e8; text-align: center;">Therapeutic Outings Schedule</h2>
        <h3 style="text-align: center; color: #666;">Tuesday, ${weekData.dateStr}</h3>
        
        <p>Good morning,</p>
        <p>Please find below the therapeutic outings schedule for <strong>Tuesday, ${weekData.dateStr}</strong>.</p>
        <p>Please review with your respective teams to ensure everyone is prepared with appropriate attire and any necessary items.</p>
        
        ${scheduleTable}
        
        <div style="background-color: #fff3cd; border: 1px solid #ffeaa7; border-radius: 8px; padding: 20px; margin: 20px 0;">
          <h3 style="color: #856404; margin-top: 0;">🛡️ Standard Outing Expectations</h3>
          <div style="color: #856404;">
            <p><strong>✅ Searches:</strong> Conduct thorough searches on all clients before they enter the van for transport to and from the outing. If any contraband is found, notify PC/APC's immediately.</p>
            
            <p><strong>✅ Supervision:</strong> Maintain constant supervision of clients throughout the outing. If a client needs to use the restroom, a CA must escort them to it.</p>
            
            <p><strong>✅ Client Conduct:</strong></p>
            <ul>
              <li>Ensure clients do not engage in conversations with the public.</li>
              <li>Be mindful of any wandering behavior—clients should not be looking for cigarettes, vapes, or contraband. Redirect and remain vigilant.</li>
            </ul>
            
            <p><strong>✅ Incident Protocol:</strong> If any issues arise, contact PC/APC and transport clients back to the appropriate property as needed.</p>
          </div>
        </div>
        
        <div style="background-color: #f8f9fa; border: 1px solid #dee2e6; border-radius: 5px; padding: 15px; margin: 20px 0;">
          <h4 style="margin-top: 0; color: #495057;">Action Items:</h4>
          <ul style="margin: 0; color: #495057;">
            <li>Verify transportation arrangements</li>
            <li>Confirm participant readiness</li>
            <li>Review vendor-specific requirements</li>
            <li>Ensure emergency contact information is up-to-date</li>
          </ul>
        </div>
        
        <p>If you have any questions or need to make changes, please contact the scheduling coordinator.</p>
        <hr style="border: none; border-top: 1px solid #dadce0; margin: 20px 0;">
        <p style="font-size: 12px; color: #5f6368; text-align: center;">
          This is an automated message from the Family First Therapeutic Outings Scheduler<br>
          <em>Powered by ClearHive Health | v${CONFIG.VERSION}</em><br>
          <em>Please do not reply to this email. For support, contact your system administrator.</em>
        </p>
      </div>
    `;
    ...
    try {
      // Use work account email sending
      sendEmailFromWorkAccount(recipient, subject, plainBody, htmlBody);
  ...
  createHtmlEmailBody(weekData, tableHtml) {
    ...
    return `
      <div style="font-family: Arial, sans-serif; color: #333; max-width: 800px; margin: 0 auto;">
        <div style="background: linear-gradient(135deg, #1a73e8 0%, #1557b0 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
          <h1 style="color: white; margin: 0; font-size: 28px;">Family First Adolescent Services</h1>
          <p style="color: #e3f2fd; margin: 10px 0; font-size: 18px;">Therapeutic Outings Schedule</p>
          <p style="color: #bbdefb; margin: 5px 0; font-size: 16px;">Week of ${weekData.dateStr}</p>
        </div>
        ...
        <div style="padding: 30px; background-color: #ffffff;">
          ...
          <div style="background: #fff3cd; border: 1px solid #ffeaa7; padding: 15px; margin-bottom: 20px; border-radius: 5px;">
            <p style="margin: 0; color: #856404;">
              <strong>⚠️ Email Delivery Notice:</strong> This email was sent from a personal account. 
              Some recipients may need to check their spam folder.
            </p>
          </div>
          `}
          ...
          <div style="background-color: #e3f2fd; border-left: 4px solid #1976d2; padding: 20px; margin: 30px 0;">
            <h3 style="margin-top: 0; color: #1565c0;">📋 Standard Outing Expectations</h3>
            <p><strong>✅ Searches:</strong> Conduct thorough searches on all clients before they enter the van for transport to and from the outing. If any contraband is found, notify PC/APC's immediately.</p>
            <p><strong>✅ Supervision:</strong> Maintain constant supervision of clients throughout the outing. If a client needs to use the restroom, a CA must escort them to it.</p>
            <p><strong>✅ Client Conduct:</strong></p>
            <ul>
  ...
  createScheduleTableHtml(weekData) {
    ...
    let html = `
      <table style="width: 100%; border-collapse: collapse; margin: 20px 0; font-family: Arial, sans-serif;">
        <tr style="background-color: #1a73e8; color: white;">
          <th style="padding: 12px; text-align: left; border: 1px solid #ddd;">House</th>
          <th style="padding: 12px; text-align: left; border: 1px solid #ddd;">Vendor</th>
          <th style="padding: 12px; text-align: left; border: 1px solid #ddd;">Time</th>
          <th style="padding: 12px; text-align: left; border: 1px solid #ddd;">Contact Info</th>
        </tr>`;
    ...
    for (let i = 0; i < houseColumns.length; i++) {
      ...
      if (cellData && cellData !== 'TBD' && cellData !== 'UNASSIGNED' && cellData.toString().trim() !== '') {
        ...
        html += `
          <tr>
            <td style="padding: 12px; border: 1px solid #ddd; font-weight: bold; background-color: ${houseHeaderColor}; color: ${houseColor};">${house}</td>
            <td style="padding: 12px; border: 1px solid #ddd; background-color: ${bgColor};">${vendor}</td>
            <td style="padding: 12px; border: 1px solid #ddd;">${time}</td>
            <td style="padding: 12px; border: 1px solid #ddd; font-size: 11px; color: #666;">${contactInfo}</td>
          </tr>`;
        ...
        html += `
          <tr>
            <td style="padding: 12px; border: 1px solid #ddd; font-weight: bold; background-color: ${houseHeaderColor}; color: ${houseColor};">${house}</td>
            <td colspan="3" style="padding: 12px; border: 1px solid #ddd; color: #666; font-style: italic;">No outing scheduled</td>
          </tr>`;
      }
    }
    ...
    if (!hasScheduledOuting || houseColumns.length === 0) {
      html += `
        <tr>
          <td colspan="4" style="padding: 20px; border: 1px solid #ddd; text-align: center; color: #666;">
        ...
        <ol>
          <li><strong>Create a Google Form</strong> manually with these fields:
            <ul style="font-size: 14px; margin: 10px 0;">
              ...
              <li>PC/APC Notified (Multiple choice)</li>
...
function generateVendorSchedulePdfs() {
  ...
  if (!CONFIG.VENDOR_PDF_FOLDER_ID || CONFIG.VENDOR_PDF_FOLDER_ID === 'your-folder-id-here') {
    const result = ui.alert(
      '📁 Setup Required',
      'To generate vendor PDFs, you need to:\n\n' +
      '1. Create a folder in Google Drive for vendor PDFs\n' +
      '2. Copy the folder ID from the URL\n' +
      '3. Update CONFIG.VENDOR_PDF_FOLDER_ID in the script\n\n' +
      'Would you like to create a folder now?',
      ui.ButtonSet.YES_NO
    );
    
    if (result === ui.Button.YES) {
      const folder = DriveApp.createFolder('Vendor Schedule PDFs - ' + new Date().getFullYear());
      ui.alert(
        'Folder Created',
        'Folder created!\n\n' +
        'Folder ID: ' + folder.getId() + '\n\n' +
        'Update CONFIG.VENDOR_PDF_FOLDER_ID with this ID.',
        ui.ButtonSet.OK
      );
    }
    return;
  ...
  try {
    ...
    let folder;
    try {
      folder = DriveApp.getFolderById(CONFIG.VENDOR_PDF_FOLDER_ID);
    } catch (e) {
...
function validateSchedulingData(programs, vendors, rules) {
  ...
  if (vendorNames.length === 0) {
    ...
    vendorNames.forEach(name => {
      ...
      if (v.CalendarId && !CalendarApp.getCalendarById(v.CalendarId)) {
        errors.push(`Vendor "${name}": Invalid calendar ID`);
      }
    });
  }
  ...
  Object.keys(rules).forEach(month => {
    ...
    if (rule.PreferredOrder) {
      rule.PreferredOrder.forEach(vendorName => {
        if (!vendorNames.some(v => 
          v === vendorName || 
          vendors[v]._key === vendorName.toLowerCase().replace(/[^a-z0-9]/g, '')
        )) {
          errors.push(`Rule month ${month}: Unknown vendor "${vendorName}"`);
        }
      });
    }
  });
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; line-height: 1.6;">
      ...
      <div style="background: white; padding: 25px; border: 1px solid #dadce0; border-top: none;">
        ...
        <div style="background: #f3e8ff; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #9334e6; text-align: center;">
          <h2 style="color: #7c3aed; margin-top: 0; font-size: 18px;">✨ That's It!</h2>
  ...
  const html = HtmlService.createHtmlOutput(`
    <div style="font-family: 'Google Sans', Roboto, Arial, sans-serif; padding: 20px; line-height: 1.6;">
      ...
      <div style="background: #f3e8ff; padding: 15px; border-radius: 8px;">
        <h4 style="color: #7c3aed; margin-top: 0;">📧 Receiving Schedule Emails</h4>
        ...
        <h4 style="color: #7c3aed; margin-top: 15px;">📞 Using Vendor Information</h4>
        <p style="margin: 5px 0; font-size: 14px;">
        ...
        <h4 style="color: #7c3aed; margin-top: 15px;">📋 Schedule Changes</h4>
        <p style="margin: 5px 0; font-size: 14px;">
      ...
      <div style="margin-top: 20px; padding: 15px; background: #f8f9fa; border-radius: 8px; border-left: 4px solid #1a73e8;">
        <p style="margin: 0; font-size: 12px; color: #666;">
          ...
          <strong>Version:</strong> ${CONFIG.VERSION} | <strong>Last Updated:</strong> August 29, 2025
        </p>
      </div>
    </div>
  `)
  ...
  const htmlContent = `
    <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background: #f3e8ff; padding: 20px; border-radius: 8px; margin: 20px 0;">
        <h2 style="color: #7c3aed; margin-top: 0;">� Using Reports</h2>
        <ul>
...
function createVendorCalendarLinksSheet() {
  ...
  ui.alert(
    ...
    'The sheet contains all your vendor calendar IDs and shareable links.\n' +
    'You can copy these links to share with new vendor representatives.',
    ui.ButtonSet.OK
  );
